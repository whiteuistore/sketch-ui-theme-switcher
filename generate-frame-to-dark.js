...
function main() {
    ...
    selectedFrames.forEach(frame => {
        ...
        newFrame.name = frame.name + " Dark Theme";
        ...
        instances.forEach(instance => {
            ...
            const isAlreadyDark = RULES.some(r => currentName.endsWith(r.replace));
    ...
    if (response === 1000) {
        ...
        document.selectedLayers = duplicatedFrames;
        sketch.UI.message("✅ Dark Theme generated! Variables skipped.");
    }
}
